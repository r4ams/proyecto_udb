...
const props = defineProps(['reservation', 'tables']);
...
const submit = () => {
  form.put(route('reservations.update', props.reservation.id), { preserveScroll: true });
};
</script>
  ...
  <AppLayout title="Editar Reservación">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
      <div class="p-6 bg-white border-b border-gray-200">
        <h1 class="text-2xl font-bold">Editar Reservación</h1>
